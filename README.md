...
***Note: This game is experimental, and the python version of the game is to find game flaws.  Please report all issues with `bug`, `gameplay`, or `missing feature` labels in issues when you find them so that we can improve the game. Thanks! `-trevormurphy424`***
...
### Help! I have a conflict with another player!
